...
| 10 | Unbounded Consumption | **[Rogue Agents (ASI10)](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/)** — agents escape guardrails, self-replicate, or act outside boundaries | **Defender for Cloud AI threat protection** (15+ detection types), **Entra Agent ID lifecycle management**, **APIM quotas**, **Azure Cost Management + token-based charging alerts** (detect runaway agent consumption) |
